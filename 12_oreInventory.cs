...
string CONTAINER_NAME = "РК-2 контейнер";




List<string> displayNames = new List<string>() { "РК-2 ЖК-панель 1", "РК-2 ЖК-панель 2", "РК-2 ЖК-панель 3" };
List<string> displayTexts = new List<string>(displayNames.Count);
List<IMyTextSurface> displayOutputs = new List<IMyTextSurface>(displayNames.Count);
